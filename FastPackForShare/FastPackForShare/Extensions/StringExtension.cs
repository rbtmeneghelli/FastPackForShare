...
namespace FastPackForShare.Extensions
{
    public static class StringExtension
    {
        ...
        public static string GetDescriptionByBoolean(this bool? status) => status.HasValue ?
                                                       (status.Value ? EnumChoice.Sim.GetDisplayShortName() : EnumChoice.Não.GetDisplayShortName())
                                                       : EnumChoice.Não.GetDisplayShortName();

        public static string GetDescriptionByBoolean(this bool status) => status ? EnumChoice.Sim.GetDisplayShortName() : EnumChoice.Não.GetDisplayShortName();
