...
using RequestExceptionActionProcessorStrategy = FastPackForShare.SimpleMediator.MicrosofExtensionsDI.RequestExceptionActionProcessorStrategy;

namespace FastPackForShare.Containers;

public static class ContainerFPFSSimpleMediator
{
    ...
    public static void SetGenericRequestHandlerRegistrationLimitations(SimpleMediatRServiceConfiguration configuration)
    {
    ...
    public static void AddMediatRClassesWithTimeout(IServiceCollection services, SimpleMediatRServiceConfiguration configuration)
    {
    ...
    public static void AddMediatRClasses(IServiceCollection services, SimpleMediatRServiceConfiguration configuration, CancellationToken cancellationToken = default)
    {
    ...
    public static void AddRequiredServices(IServiceCollection services, SimpleMediatRServiceConfiguration serviceConfiguration)
    {
