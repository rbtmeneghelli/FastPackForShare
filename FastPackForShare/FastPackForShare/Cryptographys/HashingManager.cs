...
public sealed class HashingManager
{
    ...
    // Chamando essa classe para uso
    // var hashing = new HashingManager();
    // var hash = hashing.HashToString("test"); Transforma a senha em hash
    // var isValid = hashing.Verify("test", hash); Valida se o hash fornecido e valido
}
